...
componentDidMount() {
    ...
    initModelHandler() {
        this.setState({
            ...
            model: {
                nodeDataArray: [
                    { key: 'Feeder1', label: 'Feeder1', color: 'lightgreen' },
                    { key: 'Feeder2', label: 'Feeder2', color: 'lightgreen' },
                    { key: 'Feeder3', label: 'Feeder3', color: 'lightgreen' },
                    { key: 'Feeder4', label: 'Feeder4', color: 'lightgreen' },
                    { key: 'sw1010', label: 'sw1010', color: 'red' },
                    { key: 'sw1011', label: 'sw1011', color: 'red' },
                    { key: 'sw1012', label: 'sw1012', color: 'red' },
                    { key: 'sw1018', label: 'sw1018', color: 'red' },
                    { key: 'sw1014', label: 'sw1014', color: 'red' },
                    { key: 'sw1015', label: 'sw1015', color: 'lightblue' },
                    { key: 'sw1016', label: 'sw1016', color: 'red' },
                    { key: 'sw1017', label: 'sw1017', color: 'red' },
                    { key: 'sw1018', label: 'sw1018', color: 'lightblue' },
                    { key: 'sw1019', label: 'sw1019', color: 'red' },
                    { key: 'sw1020', label: 'sw1020', color: 'red' },
                    { key: 'sw1021', label: 'sw1021', color: 'lightblue' },
                    { key: 'sw1022', label: 'sw1022', color: 'red' },
                    { key: 'sw1023', label: 'sw1023', color: 'lightblue' },
                    { key: 'sw1024', label: 'sw1024', color: 'red' },
                    { key: 'sw1025', label: 'sw1025', color: 'red' },
                    { key: 'sw1026', label: 'sw1026', color: 'red' },
                    { key: 'sw1027', label: 'sw1027', color: 'red' },
                    { key: 'sw1028', label: 'sw1028', color: 'lightblue' },
                    { key: 'sw1029', label: 'sw1029', color: 'lightblue' },
                    { key: 'sw1030', label: 'sw1030', color: 'lightblue' },
                    { key: 'sw1031', label: 'sw1031', color: 'red' },
                    { key: 'sw1032', label: 'sw1032', color: 'red' },
                    { key: 'sw1033', label: 'sw1033', color: 'red' },
                    { key: 'sw1034', label: 'sw1034', color: 'red' },
                    { key: 'sw1035', label: 'sw1035', color: 'lightblue' },
                    { key: 'sw1036', label: 'sw1036', color: 'red' },
                    { key: 'sw1037', label: 'sw1037', color: 'lightblue' },
                    { key: 'sw1038', label: 'sw1038', color: 'red' },
                    { key: 'sw1039', label: 'sw1039', color: 'red' },
                    { key: 'sw1040', label: 'sw1040', color: 'red' },
                    { key: 'sw1041', label: 'sw1041', color: 'red' },
                    { key: 'sw1042', label: 'sw1042', color: 'red' },
                    { key: 'sw1043', label: 'sw1043', color: 'red' },
                    { key: 'sw1044', label: 'sw1044', color: 'red' },
                    { key: 'sw1045', label: 'sw1045', color: 'red' },
                    { key: 'sw1046', label: 'sw1046', color: 'red' },
                    { key: 'sw1047', label: 'sw1047', color: 'red' },
